 ...
 */
data class ErrorState(val code: Int, val message: String? = null) : DataState

data class ReviewState(val jia: String? = null, val sn: String? = null) : DataState
